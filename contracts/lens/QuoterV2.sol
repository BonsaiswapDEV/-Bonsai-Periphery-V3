...
import '@bonsaiswap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IBonsaiswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IBonsaiswapV3Pool) {
        return IBonsaiswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IBonsaiswapV3SwapCallback
    function bonsaiswapV3SwapCallback(
        ...
        IBonsaiswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IBonsaiswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
