...
import '@bonsaiswap/v3-core/contracts/interfaces/callback/IBonsaiswapV3FlashCallback.sol';
import '@bonsaiswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the Bonsaiswap V3 flash function
contract PairFlash is IBonsaiswapV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `bonsaiswapV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IBonsaiswapV3Pool pool = IBonsaiswapV3Pool(PoolAddress.computeAddress(factory, poolKey));
