...
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@bonsaiswap/v2-core/build/BonsaiswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { IBonsaiswapV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain'
...
const v3CoreFactoryFixture: Fixture<IBonsaiswapV3Factory> = async ([wallet]) => {
  return (await waffle.deployContract(wallet, {
    bytecode: FACTORY_BYTECODE,
    abi: FACTORY_ABI,
  })) as IBonsaiswapV3Factory
}

export const v3RouterFixture: Fixture<{
  weth9: IWETH9
  factory: IBonsaiswapV3Factory
