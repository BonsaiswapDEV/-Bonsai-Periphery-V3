import { abi as IBonsaiswapV3PoolABI } from '@bonsaiswap/v3-core/artifacts/contracts/interfaces/IBonsaiswapV3Pool.sol/IBonsaiswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IBonsaiswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IBonsaiswapV3Pool, IBonsaiswapV3Pool, IBonsaiswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IBonsaiswapV3PoolABI, wallet)) as [
      IBonsaiswapV3Pool,
      IBonsaiswapV3Pool,
      IBonsaiswapV3Pool
    ]
  ...
  let pools: [IBonsaiswapV3Pool, IBonsaiswapV3Pool, IBonsaiswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestBonsaiswapV3Callee')
